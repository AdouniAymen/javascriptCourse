...
document.body.addEventListener('keydown', (event) => {
  if (event.key === 'r') { playGame('rock') }
      ...
      function playGame(playerMove) {
        ...
        document.querySelector('.js-moves').innerHTML = `You <img src="Images/${playerMove}-emoji.png" width="50px" alt=""><img src="Images/${computerMove}-emoji.png" width="50px" alt="">  Computer`;
      }
...
function reset() {
  document.querySelector('.js-confirmation').innerHTML = `
      ...
      <button class="js-confirmation-button confirmation-button">Yes</button>
      <button class="js-cancel-button confirmation-button">No</button>`
      document.querySelector('.js-confirmation-button').addEventListener('click', () => {
        score.wins = 0;
        score.losses = 0;
        score.ties = 0;
